    ...
    class ex6_1 {
        public static void main(String args[]) {
            ...
            person1FriendArray[0] = new Person("Jiro", "Osaka", 1981, 6, 18, "090-8765-4321");
            person1FriendArray[1] = new Person("Saburo", "Aichi", 1981, 12, 23, "090-3333-5555");
         
            person2FriendArray[0] = new Person("Taro", "Tokyo", 1985, 9, 20, "080-1234-5678");
            person2FriendArray[1] = new Person("Saburo", "Aichi", 1981, 12, 23, "090-3333-5555");
            person2FriendArray[2] = new Person("Shiro", "Gifu"  , 1974,  2,  3, "090-2222-1111");
         
            person3FriendArray[0] = new Person("Shiro", "Gifu"  , 1974,  2,  3, "090-2222-1111");
         
            person4FriendArray[0] = new Person("Jiro", "Osaka", 1981, 6, 18, "090-8765-4321");
            person4FriendArray[1] = new Person("Saburo", "Aichi", 1981, 12, 23, "090-3333-5555");
